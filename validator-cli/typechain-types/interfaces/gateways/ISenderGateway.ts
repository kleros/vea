...
export interface ISenderGatewayInterface extends utils.Interface {
  functions: {
    "receiverGateway()": FunctionFragment;
    "veaInbox()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "receiverGateway" | "veaInbox"): FunctionFragment;
...
export interface ISenderGateway extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISenderGatewayInterface;
