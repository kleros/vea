...
export interface VeaOutboxMultiChallengeInterface extends utils.Interface {
  functions: {
  ...
  getFunction(nameOrSignatureOrTopic: "deposit" | "multiChallenge" | "veaOutboxOnL1"): FunctionFragment;
...
export interface VeaOutboxMultiChallenge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeaOutboxMultiChallengeInterface;
