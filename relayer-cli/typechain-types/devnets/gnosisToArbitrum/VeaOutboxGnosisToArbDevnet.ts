...
export interface VeaOutboxGnosisToArbDevnetInterface extends utils.Interface {
  functions: {
...
export interface VeaOutboxGnosisToArbDevnet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeaOutboxGnosisToArbDevnetInterface;
