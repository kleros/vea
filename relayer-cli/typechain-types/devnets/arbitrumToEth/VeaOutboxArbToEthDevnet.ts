...
export interface VeaOutboxArbToEthDevnetInterface extends utils.Interface {
  functions: {
    ...
    "changeDevnetOperator(address)": FunctionFragment;
    "claim(uint256,bytes32)": FunctionFragment;
    "claimHashes(uint256)": FunctionFragment;
    "deposit()": FunctionFragment;
    "depositPlusReward()": FunctionFragment;
    "devnetAdvanceState(uint256,bytes32)": FunctionFragment;
    "devnetOperator()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "changeDevnetOperator", values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "devnetAdvanceState",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]
  ): string;
...
export interface VeaOutboxArbToEthDevnet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeaOutboxArbToEthDevnetInterface;
  ...
  functions: {
    ...
    changeDevnetOperator(
      _devnetOperator: PromiseOrValue<string>,
    ...
    devnetOperator(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    changeDevnetOperator(_devnetOperator: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    devnetOperator(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    devnetOperator(overrides?: CallOverrides): Promise<PopulatedTransaction>;
