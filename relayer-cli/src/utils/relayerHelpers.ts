...
async function initialize(
...
): Promise<{ nonce: number | null; hashiNonce: number | null }> {
  ...
  if ("hashiNonce" in chain_state) {
    hashiNonce = chain_state["hashiNonce"];
  }

  return { nonce, hashiNonce };
}
